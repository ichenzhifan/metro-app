(function () {
    ...
    // Check whether the internet is avaiable
    function _isInternetAvaiable() {
    ...
    function _downloadFeeds(feedsUrl, target, topnumber) {
        ...
        var isInternetAvaiable = _isInternetAvaiable();
        ...
        return _isFeedLastUpdateInOneHour(target, checkResult).then(function () {
            ...
            // If the feed is updated in one hour or the internet is not avaiable, then used the cached feed            
            if (((checkResult.result || !isInternetAvaiable) && App.Data.useCache())) {
                // The cached feed file shouldn't been null.           
                if (!checkResult.file) {
                    throw new Error("No cached file and not internet avaiable, please check your network");
                }
    ...
    function _showInternetNotAvaiable() {
    ...
    WinJS.Namespace.define("App.Data", {
        ...
        isInternetAvaiable: _isInternetAvaiable,
        showInternetNotAvaiable: _showInternetNotAvaiable,

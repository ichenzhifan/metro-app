...
(function () {
    ...
    function shareLinkHandler(e) {
        ...
        request.data.properties.title = "Share link from fox40 win8 app";
    ...
    function _refresh(callback) {
        var isIneternetAvaiable = App.Data.isInternetAvaiable();
    ...
    WinJS.UI.Pages.define("/pages/articlereader/articlereader.html", {
        ...
        updateLayout: function (element, viewState, lastViewState) {
            var isSnappedView = Windows.UI.ViewManagement.ApplicationView.value === Windows.UI.ViewManagement.ApplicationViewState.snapped;
            if (isSnappedView) {

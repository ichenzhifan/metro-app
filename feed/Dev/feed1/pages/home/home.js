(function () {
    ...
    // hide the advertising control if internet is not avaiable
    function _hideAdvertisingControlIfInternetNotAvaiable() {
        var isInternetAvaiable = App.Data.isInternetAvaiable();
    ...
    function _setVisiableForLoadingIndicator(visiable) {
        ...
        if (visiable) {
            ...
            if (App.Data.splashWindow !== null && App.Data.splashWindow !== undefined) {
                App.Data.splashWindow.Dispose();
                App.Data.splashWindow = null;
            }
        }
    }
    ...
    function _bindingDataSource(refresh) {
        ...
        _hideAdvertisingControlIfInternetNotAvaiable();
        currentError = null;
        try {

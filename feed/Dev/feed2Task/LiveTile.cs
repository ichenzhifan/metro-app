    ...
    { 
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            {               
                ...
                List<FeedItem> items = await GetFeedAsync("http://www.q13fox.com/feed/");
        ...
        private void updateTileWideImageAndText01(string text, string url)
        {
            ...
            tileImageAttributes[0].Attributes[1].InnerText = baseUri + url;//"ms-appx:///images/redWide.png");
